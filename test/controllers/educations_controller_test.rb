...
class EducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post educations_url, params: { education: { degree: @education.degree, description: @education.description, institution: @education.institution, place: @education.place, user_id: @education.user_id } }
    end
  ...
  test "should update education" do
    patch education_url(@education), params: { education: { degree: @education.degree, description: @education.description, institution: @education.institution, place: @education.place, user_id: @education.user_id } }
